...
function drop(ev) {
  ev.preventDefault();
  var data = getWeatherData(ev.dataTransfer.getData("text"));
    var dataX = data[0];
    var dataY = data[1]; 
...
function getWeatherData(chartId){
  if(changeDate == 0){
    switch(chartId){
      case "grid0":
        dataY = ['Temperatura', 29, 30, 29, 28, 28, 27, 28, 29 , 28, 29, 30, 31 , 30 , 29, 29 , 29, 29, 29, 29, 30 , 28, 27, 29, 29];
        break;
      case "grid1":
      ...
      case "grid3":
        ...
        break;
      case "grid4":
        dataY = ['UV', 3.23132, 3.231123, 3.6544, 3.321321, 3.13211, 3.31231, 3.321, 3.1231 , 3.31321, 3.31321, 3.1321, 3.32131, 3.231321 , 2.65464, 2.54654 , 2.564654, 2.45464, 2., 2.41111, 2.1213, 2.3212, 2.321321, 2.32131, 2.321321];
        break;
      case "grid5":
